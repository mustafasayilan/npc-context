...
Профиль GitHub Sponsors привязан к учетной записи пользователя или организации, а не к отдельному репозиторию. Этот репозиторий связывает кнопку Sponsor с профилем maintainer через `.github/FUNDING.yml`.

...
1. Run `npc-context context "<user task>" --root . --agent codex` before opening or searching project files.
...
6. A compatibility copy may also be written to `.codex-npc/task-context.md` for older Codex instructions.
